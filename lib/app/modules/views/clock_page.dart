    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          //   child: CircleAvatar(
          //     radius: 50,
          //     backgroundImage: AssetImage("Images/sohaib.jpg"),
          //   ),
          // ),
          Row(
            children: [
                  ...
                  children: [
                    Flexible(
                      ...
                      child: Text(
                        'Sohaib Saleem',
                        style: TextStyle(
                            fontFamily: 'avenir', fontWeight: FontWeight.w700, color: CustomColors.primaryTextColor, fontSize: 16),
                      ),
                    ),
                    Center(
                      child: CircleAvatar(
                        radius: 25,
                        backgroundImage: AssetImage("assets/sohaib.jpg"),
                      ),
                    ),
                  ],
                ),
